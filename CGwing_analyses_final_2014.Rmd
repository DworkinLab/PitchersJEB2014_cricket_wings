...
# NB:– MAKE SURE TO CHANGE THIS LINE TO *YOUR* WORKING DIRECTORY!
setwd( "/Volumes/Old_HD/DocStore/=WORK=/Cricket_Wings/" )

landmarks <- read.csv( "Cricket_Wing_LMs.csv" )
names(landmarks)

calls <- read.csv( "CGCricketCallMeasures.csv" )
names(calls)
